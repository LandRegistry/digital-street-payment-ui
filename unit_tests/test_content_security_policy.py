...
from payment.custom_extensions.content_security_policy.main import ContentSecurityPolicy
from payment.custom_extensions.content_security_policy.main import ResponseWithoutCSP
...
class TestContentSecurityPolicy(unittest.TestCase):
    ...
    @mock.patch('payment.custom_extensions.content_security_policy.main.ContentSecurityPolicy.init_app')
    ...
    @mock.patch('payment.custom_extensions.content_security_policy.reporting.logger.error')
